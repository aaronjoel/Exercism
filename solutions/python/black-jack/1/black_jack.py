...
def is_blackjack(card_one, card_two):
    ...
    return (val_one == 10 and card_two == 'A') or (card_one == 'A' and val_two == 10)
...
def can_double_down(card_one, card_two):
    ...
    """
    total_val = value_of_card(card_one) + value_of_card(card_two)
    return total_val in [9, 10, 11]
