...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    less_than_5hk = (temperature * neutrons_emitted) < 500000
    is_critical = (temperature < 800) and (neutrons_emitted > 500) and less_than_5hk
    return is_critical
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if critical < (0.9 * threshold):
        return 'LOW'
    if (0.9 * threshold) <= critical and critical <= (1.1 * threshold):
        return 'NORMAL'
